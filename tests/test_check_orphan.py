...
class TestCheckOrphan(unittest.TestCase):
    ...
    def test_detect_coverage(self):
        tss = {"seq_id": "aaa", "source": "Refseq", "feature": "TSS",
               "start": 2, "end": 2, "phase": ".", "strand": "+", "score": "."}
        ref = {"seq_id": "aaa", "source": "Refseq", "feature": "TSS",
               "start": 3, "end": 3, "phase": ".", "strand": "+", "score": "."}
    ...
    def test_del_repeat(self):
        tss_dict = [{"seq_id": "aaa", "source": "Refseq", "feature": "TSS",
                     "start": 2, "end": 2, "phase": ".", "strand": "+",
                     "score": "."},
                    {"seq_id": "aaa", "source": "Refseq", "feature": "TSS",
                     "start": 22, "end": 22, "phase": ".", "strand": "+",
                     "score": "."},
                    {"seq_id": "aaa", "source": "Refseq", "feature": "TSS",
                     "start": 122, "end": 122, "phase": ".", "strand": "-",
                     "score": "."}]
        attributes = [{"type": "Primary", "ID": "tss0", "Name": "TSS:2_+",
                       "UTR_length": "Primary_100",
                       "associated_gene": "AAA_00001"},
                      {"type": "Primary&Primary", "ID": "tss1",
                       "Name": "TSS:22_+", "UTR_length": "Primary_20&Primary_50",
                       "associated_gene": "AAA_00004&AAA_00005"},
                       {"type": "Secondary&Internal", "ID": "tss2",
                        "Name": "TSS:122_-",
                        "UTR_length": "Secondary_220&Internal_NA",
                        "associated_gene": "AAA_00008&AAA_00009"}]
        tsss = []
        for index in range(0, 3):
            tsss.append(Create_generator(tss_dict[index], attributes[index],
                                         "gff"))
        co.del_repeat(tsss)
        utrs = []
        for tss in tsss:
            utrs.append(tss.attributes["UTR_length"])
        self.assertEqual(set(utrs), set(["Primary_100", "Primary_20",
                                         "Internal_NA&Secondary_220"]))

    def test_fix_attributes(self):
        tss_entry = {"locus": "AAA_00003"}
        tss = Create_generator(self.example.tss_dict, self.example.attributes,
                               "gff")
    ...
    def test_get_primary_locus_tag(self):
        ...
        self.assertListEqual(tsss, [
            {'utr': 100, 'locus': 'AAA_00001', 'type': 'Primary'},
    ...
    def test_fix_primary_type(self):
        tss_dict = [{"seq_id": "aaa", "source": "Refseq", "feature": "TSS",
                     ...
                     "score": "."},
                    {"seq_id": "aaa", "source": "Refseq", "feature": "TSS",
                     "start": 3, "end": 3, "phase": ".", "strand": "+",
                     "score": "."},
                    {"seq_id": "aaa", "source": "Refseq", "feature": "TSS",
                     "start": 4, "end": 4, "phase": ".", "strand": "+",
                     "score": "."}]
        attributes = [{"type": "Primary", "ID": "tss0", "Name": "TSS:2_+",
                       "UTR_length": "Primary_10",
                       "associated_gene": "AAA_00001"},
                      {"type": "Primary&Internal", "ID": "tss1",
                       "Name": "TSS:3_+", "UTR_length": "Primary_20&Internal_NA",
                       "associated_gene": "AAA_00001&AAA_00005"},
                      {"type": "Primary&Primary", "ID": "tss2",
                       "Name": "TSS:4_+", "UTR_length": "Primary_40&Primary_60",
                       "associated_gene": "AAA_00001&AAA_00004"}]
        tsss = []
        for index in range(0, 3):
            tsss.append(Create_generator(tss_dict[index], attributes[index],
                                         "gff"))
        new_tsss = co.fix_primary_type(
            tsss, self.example.wigs_f, self.example.wigs_r)
        utrs = []
        for tss in new_tsss:
            utrs.append(tss.attributes["UTR_length"])
        self.assertEqual(set(utrs), set([
            "Internal_NA&Secondary_20", "Primary_60", "Primary_10"]))
    ...
    def test_read_wig(self):
        ...
        self.assertDictEqual(wigs, {
            'aaa': {'track_1': [
                {'pos': 1, 'coverage': 300, 'strand': '+'},
    ...
    def test_compare_cds_check_orphan(self):
        ...
        gff_dict = [{"start": 600, "end": 1517, "phase": ".",
                    ...
                    {"start": 3544, "end": 6517, "phase": ".",
                     ...
                     "source": "Refseq", "feature": "CDS"}]
        attributes_tss = [
            {"type": "Orphan", "ID": "tss0", "Name": "TSS:517_+",
        ...
        out_tss = [
            {'Name': 'TSS:517_+', 'ID': 'tss0', 'associated_gene': 'AAA_00001',
             'type': 'Primary', 'UTR_length': 'Primary_83'},
            {'Name': 'TSS:1234_+', 'ID': 'tss1',
             'associated_gene': 'AAA_00001&AAA_00002',
             'type': 'Internal&Primary',
             'UTR_length': 'Internal_NA&Primary_24'},
...
class Example(object):
    ...
    tss_dict = {"seq_id": "aaa", "source": "Refseq", "feature": "TSS",
                "start": 2, "end": 2, "phase": ".", "strand": "+",
                "score": "."}
    attributes = {"type": "Primary&Primary", "ID": "tss0",
                  "Name": "TSS:2_+",
                  "UTR_length": "Primary_100&Primary_120",
