...
class TestStatsORF(unittest.TestCase):
    ...
    def test_create_dict(self):
        ...
        self.assertDictEqual(
            datas, {'aaa': {'interCDS': {
                'TSS_sRNA_RBS': 0, 'sRNA': 0, 'TSS': 0,
                'TSS_RBS': 0, 'all': 0, 'RBS_sRNA': 0, 'RBS': 0,
                'TSS_sRNA': 0},
                            'intergenic': {
                'TSS_sRNA_RBS': 0, 'sRNA': 0, 'TSS': 0, 'TSS_RBS': 0,
    ...
    def test_plus_data(self):
        ...
        self.assertDictEqual(nums, {'aaa': {'5utr': {'CDS': 3, 'tRNA': 1},
                                            '3utr': {'CDS': 1}}})

    def test_print_num(self):
        out = StringIO()
        nums = {"aaa": {"3utr": {"CDS": 0, "all": 10},
                        "5utr": {"CDS": 2, "tRNA": 1, "all": 10},
                        "all": {"all": 20}}}
    ...
    def test_print_stat(self):
        out = StringIO()
        nums = {"aaa": {"test1": {"sRNA": 10, "all": 30},
                        "test2": {"sRNA": 2, "all": 10},
                        "all": {"all": 40, "sRNA": 12}}}
        nums_best = {"aaa": {"test1": {"sRNA": 2, "all": 20},
                             "test2": {"sRNA": 2, "all": 10},
                             "all": {"all": 30, "sRNA": 4}}}
    ...
    def test_check_class(self):
        ...
        ss.check_class(self.example.sorfs[0], nums,
                       "5'UTR_derived", True, "aaa")
        self.assertDictEqual(
            nums, {'total': {"3'UTR_derived": {
                'TSS_RBS': 0, 'sRNA': 0, 'TSS_sRNA_RBS': 0, 'TSS': 0,
                'all': 0, 'TSS_sRNA': 0, 'RBS': 0, 'RBS_sRNA': 0},
                             'all': {'TSS_RBS': 0, 'sRNA': 2,
                'TSS_sRNA_RBS': 0, 'TSS': 0, 'all': 2, 'TSS_sRNA': 0,
                'RBS': 2, 'RBS_sRNA': 2},
                             'interCDS': {
                'TSS_RBS': 0, 'sRNA': 0, 'TSS_sRNA_RBS': 0,
                ...
                'TSS': 0, 'all': 0, 'TSS_sRNA': 0, 'RBS': 0, 'RBS_sRNA': 0},
                             "5'UTR_derived": {
                'TSS_RBS': 0, 'sRNA': 2, 'TSS_sRNA_RBS': 0,
                'TSS': 0, 'all': 2, 'TSS_sRNA': 0, 'RBS': 2, 'RBS_sRNA': 2}},
                   'aaa': {"3'UTR_derived": {
                'TSS_RBS': 0, 'sRNA': 0, 'TSS_sRNA_RBS': 0,
                'TSS': 0, 'all': 0, 'TSS_sRNA': 0, 'RBS': 0, 'RBS_sRNA': 0},
                           'all': {
                'TSS_RBS': 0, 'sRNA': 2, 'TSS_sRNA_RBS': 0, 'TSS': 0,
...
Staphylococcus_aureus_HG003	intergenic	sORF	4090	4158	.	-	.	ID=sorf1;Name=sORF_00001;start_TSS=TSS_4368-;with_TSS=TSS_4159-,TSS_4368-;sRNA=NA;rbs=NA;sORF_type=intergenic"""
    nums = {'aaa': {"5'UTR_derived": {
        'TSS_RBS': 0, 'sRNA': 1, 'TSS_sRNA': 0, 'TSS_sRNA_RBS': 0, 'all': 1,
        'RBS_sRNA': 1, 'TSS': 0, 'RBS': 1},
                    "3'UTR_derived": {'TSS_RBS': 0, 'sRNA': 0, 'TSS_sRNA': 0,
        'TSS_sRNA_RBS': 0, 'all': 0, 'RBS_sRNA': 0, 'TSS': 0, 'RBS': 0},
                    'antisense': {'TSS_RBS': 0, 'sRNA': 0, 'TSS_sRNA': 0,
        'TSS_sRNA_RBS': 0, 'all': 0, 'RBS_sRNA': 0, 'TSS': 0, 'RBS': 0},
                    'interCDS': {'TSS_RBS': 0, 'sRNA': 0, 'TSS_sRNA': 0,
        'TSS_sRNA_RBS': 0, 'all': 0, 'RBS_sRNA': 0, 'TSS': 0, 'RBS': 0},
                    'all': {'TSS_RBS': 0, 'sRNA': 1, 'TSS_sRNA': 0,
        'TSS_sRNA_RBS': 0, 'all': 1, 'RBS_sRNA': 1, 'TSS': 0, 'RBS': 1},
                    'intergenic': {'TSS_RBS': 0, 'sRNA': 0, 'TSS_sRNA': 0,
        'TSS_sRNA_RBS': 0, 'all': 0, 'RBS_sRNA': 0, 'TSS': 0, 'RBS': 0}},
            'total': {"5'UTR_derived": {
        'TSS_RBS': 0, 'sRNA': 1, 'TSS_sRNA': 0, 'TSS_sRNA_RBS': 0, 'all': 1,
        'RBS_sRNA': 1, 'TSS': 0, 'RBS': 1},
        ...
        'TSS_sRNA_RBS': 0, 'all': 0, 'RBS_sRNA': 0, 'TSS': 0, 'RBS': 0}}}
    sorf_dict = [{
        "seq_id": "aaa", "source": "Refseq", "feature": "sORF", "start": 5,
