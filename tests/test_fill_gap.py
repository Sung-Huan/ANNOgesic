...
class Example(object):
    ta_dict = [{"seq_id": "aaa", "source": "Refseq",
               ...
               {"seq_id": "bbb", "source": "Refseq",
                "feature": "Transcript", "start": 5269,
                "end": 6767, "phase": ".", "strand": "-", "score": "."},
               {"seq_id": "bbb", "source": "Refseq",
                "feature": "Transcript", "start": 7890,
                "end": 8767, "phase": ".", "strand": "-", "score": "."}]
    ta_long = [{"seq_id": "aaa", "source": "Refseq",
                "feature": "Transcript", "start": 140,
                "end": 367, "phase": ".", "strand": "+", "score": "."},
               {"seq_id": "aaa", "source": "Refseq",
                "feature": "Transcript", "start": 230,
    ...
    for index in range(0, 5):
        ...
        longs.append(Create_generator(
            ta_long[index], attributes_tas[index], "gff"))
