...
class TestCircRNA(unittest.TestCase):
    ...
    def test_get_feature(self):
        ...
        attributes = circ.get_feature(Create_generator(
            self.example.cds_dict, attributes_cds, "gff"))
    ...
    def test_detect_conflict(self):
        circ_dict = {"seq_id": "aaa", "source": "Refseq",
                     "feature": "circRNA", "start": 100,
                     "end": 467, "phase": ".", "strand": "+",
                     "score": ".", "support": 30,
                     "start_site": 30, "end_site": 35, "situation": "P",
                     "splice_type": "C"}
        attributes_circ = {"ID": "circrna0", "Name": "circRNA_0"}
        circrna = Create_generator(circ_dict, attributes_circ, "circ")
        gffs = [Create_generator(
            self.example.cds_dict, self.example.attributes_cds, "gff")]
...
class Example(object):
    ...
    cds_dict = {"seq_id": "aaa", "source": "Refseq", "feature": "CDS",
                "start": 122, "end": 267, "phase": ".", "strand": "+",
                "score": "."}
    attributes_cds = {"ID": "cds0", "Name": "CDS_0", "locus_tag": "AAA_00001"}

    circ_dict = [
        {"seq_id": "aaa", "source": "Refseq", "feature": "circRNA", "start": 100,
    ...
    gffs_dict = [
        {"seq_id": "aaa", "source": "Refseq", "feature": "CDS", "start": 140,
