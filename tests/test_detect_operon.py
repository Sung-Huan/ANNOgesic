...
class TestDetectOperon(unittest.TestCase):
    ...
    def test_get_term_feature(self):
        ...
        for ta in self.example.tas:
            for term in self.example.terms:
                if ta.strand == "+":
                    jump = op.get_term_feature(
                        ta, term, 5, features, datas,
                ...
                jumps.append(jump)
        self.assertEqual(set(jumps), set([
    ...
    def test_detect_features(self):
        datas = []
        for ta in self.example.tas:
            datas.append(op.detect_features(
                ta, self.example.gffs, "gene", 5, 3))
        features = []
        detects = []
        for data in datas:
...
class Example(object):
    ...
    gff_dict = [{"seq_id": "aaa", "source": "Refseq",
                 "feature": "gene", "start": 148,
                 "end": 360, "phase": ".", "strand": "+", "score": "."},
                {"seq_id": "aaa", "source": "Refseq",
                 "feature": "CDS", "start": 148,
                 "end": 360, "phase": ".", "strand": "+", "score": "."},
                {"seq_id": "aaa", "source": "Refseq",
                 "feature": "gene", "start": 220,
                 "end": 239, "phase": ".", "strand": "+", "score": "."},
                {"seq_id": "aaa", "source": "Refseq",
                 "feature": "rRNA", "start": 220,
                 "end": 239, "phase": ".", "strand": "+", "score": "."},
                {"seq_id": "bbb", "source": "Refseq",
                 "feature": "gene", "start": 400,
                 "end": 5200, "phase": ".", "strand": "-", "score": "."},
                {"seq_id": "bbb", "source": "Refseq",
                 "feature": "CDS", "start": 400,
                 "end": 5200, "phase": ".", "strand": "-", "score": "."},
                {"seq_id": "bbb", "source": "Refseq",
                 "feature": "gene", "start": 5400,
                 "end": 5800, "phase": ".", "strand": "-", "score": "."},
                {"seq_id": "bbb", "source": "Refseq",
                 "feature": "CDS", "start": 5400,
                 "end": 5800, "phase": ".", "strand": "-", "score": "."}]
    attributes_gff = [
        {"ID": "gene0", "Name": "Gene_0", "locus_tag": "AAA_00001"},
        {"ID": "cds0", "Name": "CSD_0", "locus_tag": "AAA_00001",
         "protein_id": "YP_000001"},
        {"ID": "gene1", "Name": "Gene_1", "locus_tag": "AAA_00002"},
        {"ID": "rna0", "Name": "rRNA_0", "locus_tag": "AAA_00002"},
        {"ID": "gene2", "Name": "Gene_2", "locus_tag": "BBB_00001"},
        {"ID": "cds1", "Name": "CDS_1", "locus_tag": "BBB_00001",
         "protein_id": "YP_000002"},
...
Operon3	bbb	430-5167	-	0	NA	True	1	True	1	NA	1	NA	BBB_00001"""
    ...
    for index in range(0, 3):
        tas.append(Create_generator(
            ta_dict[index], attributes_tas[index], "gff"))
        terms.append(Create_generator(
            term_dict[index], attributes_term[index], "gff"))
