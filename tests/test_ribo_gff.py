...
class TestRiboGff(unittest.TestCase):
    ...
    def test_get_overlap(self):
        pre_ribo = {"strain": "aaa", "strand": "+", "ID": "id_1", "info": "test_1"}
        ribo = {"strain": "aaa", "strand": "+", "ID": "id_1", "info": "test_2"}
        overlaps = {}
        overlaps["aaa"] = []
    ...
    def test_print_gff(self):
        ...
        self.assertEqual(out.getvalue(), "test_1\tRfam\triboswitch\t15948\t16046\t.\t+\t.\tID=ribo_1;Name=Riboswitch_00001;Type=SAM;Rfam_ID=RF00162;E_value=1.6e-18\n")

    def test_import_stat(self):
        ribo = {'associate': 'SAOUHSC_00013', 'start_seq': 15948, 'start_align': 1,
              'strain': 'Staphylococcus_aureus_HG003', 'end_align': 99, 'ID': 'riboswitch_5',
              'info': 'riboswitch_5|Staphylococcus_aureus_HG003|+|SAOUHSC_00013|15948|16046',
              'strand': '+', 'e': '1.6e-18', 'rfam': 'RF00162', 'end_seq': 16046, "rfam_name": "RF00162"}
        stats = {}
        stats["Staphylococcus_aureus_HG003"] = {"total": 0}
        stats["test"] = {"total": 0}
        stats["total"] = {"total": 0}
        rg.import_stat(self.example.rfams, ribo, stats, "Staphylococcus_aureus_HG003")
        self.assertDictEqual(stats, {'total': {'total': 0, 'SAM': 1},
...
RF00520	ybhL	ybhL leader"""
    ...
    ribos = [{'associate': 'SAOUHSC_00013', 'start_seq': 15948, 'start_align': 1,
              'strain': 'Staphylococcus_aureus_HG003', 'end_align': 99, 'ID': 'riboswitch_5',
              'info': 'riboswitch_5|Staphylococcus_aureus_HG003|+|SAOUHSC_00013|15948|16046',
              'strand': '+', 'e': '1.6e-18', 'rfam': 'RF00162', 'end_seq': 16046},
             {'associate': 'SAOUHSC_00007', 'start_seq': 27955, 'start_align': 1,
              'strain': 'Staphylococcus_aureus_HG003', 'end_align': 99, 'ID': 'riboswitch_11',
              'info': 'riboswitch_11|Staphylococcus_aureus_HG003|-|SAOUHSC_00007|27955|28053',
              'strand': '-', 'e': '1.6e-18', 'rfam': 'RF00162', 'end_seq': 28053},
             {'associate': 'SAOUHSC_00372', 'start_seq': 377996, 'start_align': 1,
              'strain': 'Staphylococcus_aureus_HG003', 'end_align': 103, 'ID': 'riboswitch_183',
              'info': 'riboswitch_183|Staphylococcus_aureus_HG003|+|SAOUHSC_00372|377996|378098',
              'strand': '+', 'e': '2.2e-18', 'rfam': 'RF00167', 'end_seq': 378098}]
    rfams = [{'class': 'SAM', 'ID': 'RF00162'}, {'class': 'TPP', 'ID': 'RF00059'},
             {'class': 'Purine', 'ID': 'RF00167'}, {'class': 'Lysine', 'ID': 'RF00168'},
             {'class': 'ybhL', 'ID': 'RF00520'}]

    out_gff = """##gff-version 3
Staphylococcus_aureus_HG003	Rfam	riboswitch	15948	16046	.	+	.	ID=ribo_0;Name=Riboswitch_00000;Type=SAM;Rfam_ID=RF00162;E_value=1.6e-18
Staphylococcus_aureus_HG003	Rfam	riboswitch	27955	28053	.	-	.	ID=ribo_1;Name=Riboswitch_00001;Type=SAM;Rfam_ID=RF00162;E_value=1.6e-18
Staphylococcus_aureus_HG003	Rfam	riboswitch	377996	378098	.	+	.	ID=ribo_2;Name=Riboswitch_00002;Type=Purine;Rfam_ID=RF00167;E_value=2.2e-18"""
