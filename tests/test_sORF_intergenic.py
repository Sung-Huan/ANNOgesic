...
class TestsORFIntergenic(unittest.TestCase):
    ...
    def test_get_type(self):
        ...
        self.assertDictEqual(inter, {'strand': '+', 'source': '5utr',
                                     'end': 149,
    ...
    def test_compare_tran_cds(self):
        ...
        self.assertListEqual(inters, [
            {'strand': '+', 'strain': 'aaa', 'start': 10, 'end': 100},
...
aaa	UTR_derived	sORF	1101	1800	.	+	.	ID=aaa_sorf2;Name=sORF_00002;UTR_type=3utr"""
    ...
    tran_dict = [
        {"seq_id": "aaa", "source": "Refseq", "feature": "transcript",
         "start": 10, "end": 100, "phase": ".", "strand": "+", "score": "."},
        {"seq_id": "aaa", "source": "Refseq", "feature": "transcript",
         "start": 1100, "end": 1240, "phase": ".", "strand": "+",
         "score": "."},
        {"seq_id": "aaa", "source": "Refseq", "feature": "transcript",
         "start": 8000, "end": 900, "phase": ".", "strand": "-",
         "score": "."}]
    ...
    for index in range(0, 3):
        ...
        trans.append(Create_generator(
            tran_dict[index], attributes_tran[index], "gff"))
