...
class SNP_calling(object):
    ...
    def _transcript_SNP(self, fasta, snp, out_table_prefix, qual, 
        ...
        stat_file = os.path.join(stat_path, 
                   "_".join(["stat", fasta_prefix + types, "SNP.csv"]))
            ...
            for fasta in os.listdir(fasta_path):
                if (fasta.split(".f")[0] in seq_names):
                    ...
                    if detect:
                        ...
                        self.helper.check_make_folder(os.path.join(out_folder, file_type, "SNP_raw_outputs"), prefix)
                        ...
                        table_path = os.path.join(out_folder, file_type, "SNP_table", prefix)
